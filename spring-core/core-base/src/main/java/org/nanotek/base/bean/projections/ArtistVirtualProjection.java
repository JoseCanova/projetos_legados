...
public interface ArtistVirtualProjection extends Base{
		...
		@Value("#{target.artistBeginDate.year}/#{target.artistBeginDate.month}/#{target.artistBeginDate.day}")
		public String getBeginDate();
		
		@JsonInclude(Include.NON_NULL)
		@JsonProperty(value = "endDate")
		@Value("#{target.artistEndDate.year}/#{target.artistEndDate.month}/#{target.artistEndDate.day}")
