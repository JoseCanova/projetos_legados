...
public class ArtistCreditController extends BaseController<ArtistCreditBaseMap , ArtistCredit, ArtistCreditParser, BaseService<ArtistCredit>>{
	...
	@Override
	public BaseService<ArtistCredit> getBaseService() {
