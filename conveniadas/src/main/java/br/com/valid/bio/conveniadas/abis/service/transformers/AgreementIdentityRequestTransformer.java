...
@Mapper
public interface AgreementIdentityRequestTransformer extends AgreementRequestTransformer<BaseRequest>{
	...
	@Mappings({
        ...
        @Mapping(source = "listSize" , target = "listSize", defaultValue = "10"),
        ...
        @Mapping(source = "threshold" , target="threshold" , defaultValue = "0.6"),
        @Mapping(source = "subjectTags" , target="subjectTags")
	})
	@Override
