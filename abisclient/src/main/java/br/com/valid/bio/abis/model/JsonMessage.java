package br.com.valid.bio.abis.model;
...
import br.com.valid.bio.abis.model.rule.RuleMessage;
...
public class JsonMessage implements Base<String>{
	...
	public RuleMessage getData() {
		return data;
	}

	public void setData(RuleMessage data) {
		this.data = data;
	}
